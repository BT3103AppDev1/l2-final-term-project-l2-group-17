...
const routes = [
  ...
  { path: '/signup', component: SignUp, meta: { hideNavbar: true, requiresGuest: true } },
  { path: '/forgot-password', component: ForgotPassword, meta: { hideNavbar: true, requiresGuest: true } },
