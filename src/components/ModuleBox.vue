...
export default {
  ...
  methods: {
    getLabelKey(prefixArray) {
      ...
      if (
        prefixArray.includes("GEA1000") ||
        prefixArray.includes("BT1101") ||
        prefixArray.includes("ST1131")
      ) {
        return "Data"; // Example condition
      }
      if (
        prefixArray.includes("CS1101S") ||
        prefixArray.includes("CS1010J") ||
        prefixArray.includes("CS1010A")
      ) {
        return "Digital"; // Example condition
      }
      if (
        prefixArray.includes("BT3") ||
        prefixArray.includes("BT4") ||
        prefixArray.includes("IS3") ||
        prefixArray.includes("IS4")
      ) {
        return "PE";
      }
