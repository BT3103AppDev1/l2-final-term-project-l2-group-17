<template>
  <div class="container-fluid py-5">
    <div class="row min-vh-100">
      ...
      <div
        class="col-md-9 col-lg-10 offset-md-3 offset-lg-2 d-flex align-items-center justify-content-center"
      >
        <div class="row justify-content-center">
          <div class="col-md-6">
            <div class="image-container">
              <img
                src="../assets/modunus_logo.png"
                alt="Modunus Logo"
            ...
            <div class="card shadow">
              <div class="card-body">
                ...
                <p class="mt-3 text-center">
                  ...
                  <router-link to="/signup">Register here.</router-link><br />
    ...
    async login() {
      ...
      try {
        ...
        if (error.code === "auth/too-many-requests") {
          this.errorMessage =
            "Access to this account has been temporarily disabled due to many failed login attempts. Please reset your password";
        } else {
